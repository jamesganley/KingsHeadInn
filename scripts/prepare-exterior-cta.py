"""Export responsive WebP versions of the reviewed wide pub entrance."""
from pathlib import Path
from PIL import Image

ROOT = Path(__file__).resolve().parents[1]
SOURCE = ROOT / 'images' / 'enhanced' / 'KingsHeadEntrance-wide-v2.png'
OUT = ROOT / 'images' / 'web'
...
with Image.open(SOURCE) as opened:
    ...
    for width in sorted({min(640, image.width), min(1200, image.width), image.width}):
        ...
        destination = OUT / f'pub-entrance-{width}.webp'
